...
func ConfirmReceiptGood(c fiber.Ctx) error {
	defer func() {
	...
	updateOrderStatusRequest := new(entity.UpdateOrderStatusRequest)

	if err := c.Bind().Body(updateOrderStatusRequest); err != nil {
